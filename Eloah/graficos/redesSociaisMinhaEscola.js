...
function processarDados(dados) {
    ...
    const layout = {
        ...
        height: 700,
        title: {
            text: 'Relação de redes sociais mais usadas nas escolas ',
            x: 0,
            font: {
    ...
    incluirTexto(`Como no mundo,a pesquisa demonstra um apreço pelo <span>Instagram</span> em relação a outras redes.`)
}
